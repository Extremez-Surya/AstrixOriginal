...
module.exports = {
  name: "channelpanel",
  category: "Moderation",
  description: "Open the channel control console.",
  ...
  async execute(client, interaction) {
    ...
    const buildPanel = (statusMessage = "Select an operation from the options below.") => {
      ...
      const row1 = new ActionRowBuilder().addComponents(
        new ButtonBuilder().setCustomId("cp_lock").setLabel("Lock").setStyle(ButtonStyle.Danger),
        new ButtonBuilder().setCustomId("cp_unlock").setLabel("Unlock").setStyle(ButtonStyle.Success),
        new ButtonBuilder().setCustomId("cp_hide").setLabel("Hide").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("cp_unhide").setLabel("Unhide").setStyle(ButtonStyle.Primary)
      );

      const row2 = new ActionRowBuilder().addComponents(
        new ButtonBuilder().setCustomId("cp_slow_0").setLabel("Slow Off").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("cp_slow_5").setLabel("Slow 5s").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("cp_slow_60").setLabel("Slow 1m").setStyle(ButtonStyle.Secondary),
        new ButtonBuilder().setCustomId("cp_purge_10").setLabel("Purge 10").setStyle(ButtonStyle.Danger)
      );
