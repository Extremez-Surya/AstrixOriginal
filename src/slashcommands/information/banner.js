...
module.exports = {
  ...
  description: "View a user's profile or server banner.",
  type: ApplicationCommandType.ChatInput,
  options: [
    {
      name: "user",
      description: "The user to get the banner for.",
  ...
  async execute(client, interaction) {
    ...
    try {
      ...
      return interaction.reply("Could not retrieve user banner data.");
    }
